    ...
    <div id="change-identify">
        <el-header>
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item class="firstbread">修改识别图</el-breadcrumb-item>
            </el-breadcrumb>
        </el-header>
        <el-row>
...
import { findIdentify, editIdentify, getIdenfityGrade, identifySimilar } from '@/api/identify'
export default {
    ...
    methods: {
        ...
        getIdentify() {
            ...
            .then(value => {
                ...
                this.uploadDisabled = true;
                this.fileList = [];
                this.ruleForm.identifyName = value.data.identifyName;
                this.ruleForm.grade = value.data.identifyGrade;
                ...
                this.ruleForm.identifyImgUrl = value.data.identifyImgUrl;
                this.ruleForm.smallIdentifyImgUrl = value.data.smallIdentifyImgUrl;
                this.ruleForm.identifySize = value.data.identifySize;
                this.fileList.push({
                    name: "1",
                    url: value.data.smallIdentifyImgUrl
                })
            })
        },
        /**
                ...
                if (valid) {
                    ...
                    .then(res => {
                        if (res.code == 0 || res == 0) {
                            ...
                            return Promise.resolve(editIdentify(data))
                        }
                    })
                    .then(value => {
                        if (value.code === 1) {
