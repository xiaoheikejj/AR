    ...
    <el-container>
        <el-header>
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item class="firstbread">LBS应用库</el-breadcrumb-item>
            </el-breadcrumb>
        </el-header>
        <el-main class="boxShadow">
            <el-row type="flex" justify="space-between" class="screenRow">
                ...
                <el-button type="primary" 
                    @click="$router.push('/addLbs')">新建应用</el-button>
            </el-row>
            <!-- 表格 -->
            <el-table
                stripe
                ...
                <el-table-column label="操作" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-tooltip class="item" effect="light" content="进入lbs配置" placement="top-start"
